...
- If an available semantic tool answers directly, use it and cite the symbol or source location; clone or fetch only when its evidence is unavailable or insufficient.
